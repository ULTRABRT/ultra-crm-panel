  ...
  return (
    <section className="h-full min-h-0 overflow-hidden rounded-[1.75rem] border border-white/10 bg-[#06111d] shadow-2xl shadow-black/45">
      <div className="flex h-full min-h-0 flex-col">
        <header className="shrink-0 border-b border-white/10 bg-[#071522]">
          <div className="flex h-[66px] items-center justify-between gap-4 px-5">
            ...
            <div className="flex min-w-0 items-center gap-2">
              <div className="hidden h-10 min-w-0 items-center gap-3 rounded-2xl border border-white/10 bg-black/25 px-4 text-white/45 lg:flex lg:w-[420px]">
        ...
        <div className="grid min-h-0 flex-1 grid-cols-[320px_minmax(0,1fr)_260px] overflow-hidden">
          ...
          <aside className="flex min-h-0 flex-col overflow-hidden border-l border-white/10 bg-[#071522]">
